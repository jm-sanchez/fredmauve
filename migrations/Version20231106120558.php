 ...
 */
final class Version20231106120558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_details_work (order_details_id INT NOT NULL, work_id INT NOT NULL, INDEX IDX_73582E58C0FA77 (order_details_id), INDEX IDX_73582E5BB3453DB (work_id), PRIMARY KEY(order_details_id, work_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE order_details ADD customer_id INT NOT NULL');
        $this->addSql('ALTER TABLE order_details ADD CONSTRAINT FK_845CA2C19395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id)');
        $this->addSql('CREATE INDEX IDX_845CA2C19395C3F3 ON order_details (customer_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_845CA2C19395C3F3 ON order_details');
        $this->addSql('ALTER TABLE order_details DROP customer_id');
    }
}
